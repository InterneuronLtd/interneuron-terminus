...
export class UpsertTransactionManager {
    ...
    save(onSuccess?: (savedDetails: any) => void, onError?: (err: any) => void, synchronousPost = true, asPromise = false) {
        ...
        var postFnExec = asPromise ? from( this.apiServiceObj.postRequest(url, this.entities, synchronousPost)) : this.apiServiceObj.postRequest(url, this.entities, synchronousPost);
